...
@section('header')
    <div class="subheader">
        ...
        <div class="subheader-block d-lg-flex align-items-center">
            <a href="{!! route('roles.create') !!}" class="btn btn-xl btn-primary
            waves-effect">Create New Role</a>
        </div>
    </div>
@stop
                        ...
                        <table id="roles" class="table table-bordered table-hover table-striped w-100">
                            ...
                            @foreach($roles as $role)
                                <tr index="{!! $role->id !!}">
                                    ...
                                    <td>
                                        <a href="{!! route('roles.edit',$role->id)!!}" class="font-weight-bold">{!! $role->name !!}</a>
                                    </td>
