...
@section('breadcrumb')
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item">Roles and Permissions</li>
...
@section('head')
    <style type="text/css">
        ...
        .daredevel-tree li span.daredevel-tree-anchor{
            background-image: url(https://cms.botble.com/vendor/core/libraries/jquery-ui/images/ui-icons_444444_256x240.png);
        }
                ...
                <div class="panel-tag">
                    ...
                    <ul id='auto-checkboxes' data-name='foo' class="list-unstyled list-feature">
                        <li id="mainNode">
                            ...
                            <label for="expandCollapseAllTree" class="label label-default allTree">{{ trans('permissions.all') }}</label>
                            <ul>
